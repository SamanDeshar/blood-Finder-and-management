...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2025 at 11:42 AM
...
CREATE TABLE `blood_bank` (
  ...
  `available_blood_groups` varchar(255) NOT NULL,
...
INSERT INTO `blood_bank` (`id`, `bloodbank_name`, `image_url`, `Address`, `contact`, `available_blood_groups`, `capacity`) VALUES
(1, 'Teaching Hospital Blood Bank', 'uploads/TUTH.jpg', 'Kathmandu', '01-4412303', 'all', 0),
(2, 'Redcross Blood Bank', 'uploads/1bnkimg.jfif', 'Lalitpur', '01-5186390', 'ab b o ab+ o- a+', 1000),
(3, 'Noble Hospital Blood Bank', 'uploads/2bankimg.jfif', 'Sinamangal Kathmandu', ' 01-4110842', 'all', 0),
(4, 'Pulchowk Blood Bank', 'uploads/splssh.png', 'lalitpur', '01-5527033', 'all', 120);
...
(1, 'Chapagaun,Lalitpur(Godawari -11)', '+9779869221526', 'sam123@gmail.com');
...
(1, 'ssss', '@gmail.com', '1', 'sadasdasd', '2024-11-13 11:30:12', NULL);
...
CREATE TABLE `donor_details` (
  ...
  `donor_address` text NOT NULL DEFAULT 'NEPAL',
  `longitude` varchar(210) NOT NULL,
  `latitude` varchar(210) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `donor_details` (`donor_id`, `donor_name`, `donor_number`, `donor_mail`, `donor_age`, `donor_gender`, `donor_blood`, `donor_address`, `longitude`, `latitude`) VALUES
(25, 'saman', '9869221526', 'sam@gmail.com', 21, 'Male', '7', 'lalitpur', '85.3318', '27.6974'),
(26, 'hari paudel', '9841367718', 'Samdesjae@gmail.com', 12, 'Female', '2', 'ktm', '85.3318', '27.6974'),
(27, 'asdnasd', 'asda', 'cvxcv@gmail.com', 12, 'Male', '5', 'dxfv', '85.3318', '27.6974'),
(28, 'roshina', '984131645', 'asdasd@gmail.com', 122, 'Male', '3', 'asdasd', '85.3318', '27.6974');
...
CREATE TABLE `need_blood` (
  ...
  `blood_group` varchar(26) NOT NULL,
...
INSERT INTO `need_blood` (`id`, `name`, `blood_group`, `reason`, `address`, `latitude`, `longitude`) VALUES
(61, 'hari chandra', 'AB+', 'asp', 'chanpgaun', '27.6974', '85.3318'),
(62, 'harii', 'AB+', 'asp', 'lalitpur', '27.6974', '85.3318'),
(63, 'hari ', 'AB+', 'asp', 'chapgaun', '', ''),
(64, 'hari', 'AB+', 'asp', 'chpagaun', '27.664701', '85.324506'),
(65, 'anil', 'AB+', 'asp', 'laltitpur', '27.664775', '85.324437');
